...
<body>
<%
    String claimedId = (String) request.getSession().getAttribute("ClaimedID");
    if(claimedId == null){
%>
...
<div id="container">
    ...
    <div id="content-area">
        ...
        <div class="product-box">
            ...
            <table>
                <%
                    if(session.getAttribute("OpenIDAttributes") != null){
                        Set<Map.Entry<String,List>> attributes = ((Map<String,List>)session.getAttribute("OpenIDAttributes")).entrySet();
